<?php
  ...
  $api_key = 'YOL3diTqB7ov1BNwKPsyqlnZbstSpiYuLjojHKZzq8A';
  $api_secret = 'pdxE5QNkZ8sGpXJVUzg2KN4EGBtvw4NAjDFBen1qDhG';
  $api_version = '';
  ...
  */
   function __construct($api_key, $api_secret, $api_version = 'v1') {
  ...
  */
  ...
  //$lay_trade = get_trades($symbol = 'BTCUSD', $data = array());
  //debug($lay_trade);
  
  
   function get_book($symbol = 'BTCUSD', $data = array()) {
  	$request = $this->endpoint('book', $symbol);
  	return $this->send__request($request, $data);
  }
  /**
  * Get Lendbook
  *
  ...
  * @return mixed
  */
   function get_lendbook($currency = 'USD', $data = array()) {
  ...
  * @return mixed
  */
   function get_lends($currency = 'USD', $data = array()) {
  ...
  * @return mixed
  */
   function get_stats($symbol = 'BTCUSD') {
  	$request = $this->endpoint('stats', $symbol);
  	return $this->send__request($request);
  }
  /**
  * Get Symbols
  *
  ...
  * @return mixed
  */
   function get_ticker($symbol = 'BTCUSD') {
  ...
  * @return mixed
  */
   function get_trades($symbol = 'BTCUSD', $data = array()) {
  ...
  * @return mixed
  */
   function new_deposit($method, $wallet_name, $renew = 0) {
  ...
  * @return mixed
  */
   function new_order($symbol, $amount, $price, $exchange, $side, $type, $is_hidden = FALSE, $is_postonly = FALSE, $ocoorder = FALSE, $buy_price_oco = NULL) {
  ...
  * @return mixed
  */
   function new_multi_order($symbol, $amount, $price, $exchange, $side, $type) {
  ...
  * @return mixed
  */
   function cancel_multi_orders($order_ids) {
  ...
  * @return mixed
  */
   function replace_order($order_id, $symbol, $amount, $price, $exchange, $side, $type, $is_hidden = FALSE, $use_remaining = FALSE) {
  ...
  * @return mixed
  */
   function claim_position($position_id, $amount) {
  ...
  * @return mixed
  */
   function get_history($currency, $wallet, $limit = 500, $since = NULL, $until = NULL) {
  ...
  * @return mixed
  */
   function get_history_movements($currency = 'USD', $method = 'bitcoin', $limit = 500, $since = NULL, $until = NULL) {
  ...
  * @return mixed
  */
   function get_my_trades($symbol = 'BTCUSD', $limit_trades = 50, $timestamp = NULL, $until = NULL, $reverse = 0) {
  ...
  * @return mixed
  */
   function new_offer($currency = 'BTC', $amount, $rate, $period, $direction = 'lend') {
  ...
  * @return mixed
  */
   function get_unused_taken_funds() {
  ...
  * @return mixed
  */
   function get_total_taken_funds() {
  ...
  * @return mixed
  */
   function close_funding($swap_id) {
  ...
  * @return mixed
  */
   function transfer($currency, $amount, $walletfrom, $walletto) {
  ...
  * @return mixed
  */
   function withdraw($withdraw_type, $walletselected, $amount, $address = '', $expressWire = 0, $bank_data = array()) {
  ...
  * @return string
  */
   function endpoint($method, $params = NULL) {
  	$parameters = '';
  	if ($params !== NULL) {
      $parameters = '/';
      if (is_array($params)) {
  ...
  * @return array
  */
   function output($result, $is_error = FALSE) {
  ...
  * @return mixed
  */
   function send_auth_request($data) {
  	$ch = curl_init();
  ...
  * @return mixed
  */
   function send__request($request, $params = NULL) {
  	$ch = curl_init();
  	$query = '';
  	if (count($params)) {
